...
```
2. #### wait for ollama to pull the models  `nomic-embed-text & mistral`
3. you will receive a message : 🎉 All models are ready! You can start sending requests to the API


4. ### Once all running , access the Link:
